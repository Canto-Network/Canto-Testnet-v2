...
A user can query the canto `x/vesting` module using the CLI, gRPC, or REST.
...
| ------ | -------------------------------------- | -------------------------------------- |
| `gRPC` | `canto.vesting.v1.Query/Balances`      | Gets locked, unvested and vested coins |
| `GET`  | `/canto/vesting/v1/balances/{address}` | Gets locked, unvested and vested coins |

### Transactions

| Verb   | Method                                                 | Description                      |
| ------ | ------------------------------------------------------ | -------------------------------- |
| `gRPC` | `canto.vesting.v1.Msg/CreateClawbackVestingAccount`    | Creates clawback vesting account |
| `gRPC` | `/canto.vesting.v1.Msg/Clawback`                       | Performs clawback                |
| `GET`  | `/canto/vesting/v1/tx/create_clawback_vesting_account` | Creates clawback vesting account |
| `GET`  | `/canto/vesting/v1/tx/clawback`                        | Performs clawback                |
