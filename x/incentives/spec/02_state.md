...
Say, there are several incentives that have registered an allocation for the $canto coin and the allocation meter for $canto is at 97%. Then a new incentve proposal can only include an $canto allocation at up to 3%, claiming the last remaining allocation capcaity from the $canto rewards in the inflation pool.
